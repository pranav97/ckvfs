...
CFLAGS=-I/usr/local/include/fuse3 -I /src/KVSSD/PDK/core/include/ -D SAMSUNG_API -Wall -g
LDFLAGS=-L/src/KVSSD/PDK/core/build/ -L/usr/local/lib/x86_64-linux-gnu -lfuse3 -lpthread

main: 
	$(CC) -g main.c $(CFLAGS) $(LDFLAGS) -lkvapi -o main
...
clean: 
	rm -f main main.o test_sync test_sync.o use_emulator.o notkvmain main use_emulator
